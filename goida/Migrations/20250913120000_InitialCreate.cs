...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ExtractFileId = table.Column<string>(type: "character varying(64)", nullable: true),
                ValidatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ValidatedFileHash = table.Column<string>(type: "text", nullable: true)
            },
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Cascade);
                table.ForeignKey(
                    name: "FK_ApplicantProfiles_StoredFiles_ExtractFileId",
                    column: x => x.ExtractFileId,
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                RawTextLine = table.Column<string>(type: "text", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_ExperienceRecords", x => x.Id);
                table.ForeignKey(
                    name: "FK_ExperienceRecords_ApplicantProfiles_ApplicantProfileId",
                    column: x => x.ApplicantProfileId,
                    principalTable: "ApplicantProfiles",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateIndex(
            name: "IX_ApplicantProfiles_ExtractFileId",
            table: "ApplicantProfiles",
            column: "ExtractFileId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_ApplicantSkills_ApplicantProfileId_Tag",
            table: "ApplicantSkills",
            columns: new[] { "ApplicantProfileId", "Tag" },
            unique: true);
        ...
        migrationBuilder.CreateIndex(
            name: "IX_ExperienceRecords_ApplicantProfileId",
    ...
    {
        migrationBuilder.DropTable(name: "ApplicantSkills");
        migrationBuilder.DropTable(name: "AspNetRoleClaims");
        migrationBuilder.DropTable(name: "AspNetUserClaims");
        migrationBuilder.DropTable(name: "AspNetUserLogins");
        migrationBuilder.DropTable(name: "AspNetUserRoles");
        migrationBuilder.DropTable(name: "AspNetUserTokens");
        migrationBuilder.DropTable(name: "ExperienceRecords");
        migrationBuilder.DropTable(name: "AspNetRoles");
        migrationBuilder.DropTable(name: "ApplicantProfiles");
